...
import styles from "./SideBarKemendagri.module.css";
...
const mainMenu = [
  { id: 1, icon: MdDashboard, name: "Dashboard", menuLink: "/pages/dashboard-kemendagri" },
  {
    id: 2,
    icon: HiOutlineClipboardList,
    name: "List Linmas",
    menuLink: "/pages/list-linmas-kemendagri",
  },
  {
    id: 3,
    icon: BsFolder2Open,
    name: "List Desa",
    menuLink: "/pages/list-desa-kemendagri",
  },
  {
    id: 4,
    icon: BsBarChartLine,
    name: "Statistik Laporan",
    menuLink: "/pages/statistik-laporan",
  },
  { id: 5, icon: ChangePassword, name: "", menuLink: "" },
];

function SideBarKemendagri() {
        ...
        >
          ...
          >
            ...
            <div className={`${styles.welcome_container} d-flex flex-column`}>
              ...
              <span className={`${styles.village_text}`}>KEMENDAGRI</span>
            </div>
          </div>
        </div>
        <div
...
export default SideBarKemendagri;
